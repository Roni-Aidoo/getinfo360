  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:22px;border:1px solid #eee;border-radius:8px;overflow:hidden;">
    ...
    <tr>
      <td style="padding:16px 18px;">
        ...
        <p style="margin:0 0 12px 0;font-size:14px;color:#444444;line-height:1.55;">Sometimes the will of God hurts, so that when you succeed, you will realize that your success is never your making.
